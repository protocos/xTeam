...
public class AdminSetLeader extends ServerAdminCommand
{
	...
	{
		ITeamPlayer playerSet = xTeamPlugin.getInstance().getPlayerManager().getPlayer(playerName);
		...
		ITeamPlayer previousLeader = xTeamPlugin.getInstance().getPlayerManager().getPlayer(playerTeam.getLeader());
	...
	public void checkRequirements(CommandSender originalSender, CommandParser parseCommand) throws TeamException, IncompatibleClassChangeError
	{
		...
		Team desiredTeam = xTeamPlugin.getInstance().getTeamManager().getTeam(teamName);
		ITeamPlayer playerSet = xTeamPlugin.getInstance().getPlayerManager().getPlayer(playerName);
		Team playerTeam = playerSet.getTeam();
