...
public class ServerAdminDebug extends ServerAdminCommand
{
	...
	protected void performCommandAction(CommandContainer commandContainer)
	{
		...
		else if (subCommand.equalsIgnoreCase("directions"))
		{
			...
			{
				Message message = new Message.Builder("Angle to " + otherPlayer.getName() + ": " + Math.round(LocationUtil.getYawDiffToLocation(player.getLocation(), otherPlayer.getLocation())))
						.addRecipients(player)
