...
public class MainHelpTest
{
	...
	public void ShouldBeTeamUserMainHelpExecute()
	{
		...
		Assert.assertEquals("------------------ [xTeam vCURRENT UserHelp] ------------------\n" +
				"xTeam is a team-based PvP fakePlugin that allows for creating and joining teams, setting a headquarters and various other features. It is meant for use on hardcore PvP servers where land is not protected!\n" +
