...
public class UserHelp extends UserCommand
{
	...
	public void checkRequirements(CommandSender originalSender, CommandParser parseCommand) throws TeamException, IncompatibleClassChangeError
	{
		...
		pages = new HelpPages();
		List<String> availableCommands = xTeam.getCommandManager().getAvailableCommandsFor(teamPlayer);
		pages.addLines(availableCommands);
		//		String temp = "user_info";
		//		pages.addLine(ChatColorUtil.formatForUser(xTeam.getCommandManager().getUsage(temp) + " - Get team info or other team's info"));
		//		if (PermissionUtil.hasPermission(originalSender, xTeam.getCommandManager().getPermissionNode(temp = "user_list")))
		//			pages.addLine(ChatColorUtil.formatForUser(xTeam.getCommandManager().getUsage(temp) + " - List all teams on the server"));
		//		if (PermissionUtil.hasPermission(originalSender, xTeam.getCommandManager().getPermissionNode(temp = "user_create")))
		//			pages.addLine(ChatColorUtil.formatForUser(xTeam.getCommandManager().getUsage(temp) + " - Create a team"));
		//		if (PermissionUtil.hasPermission(originalSender, xTeam.getCommandManager().getPermissionNode(temp = "user_join")))
		//			pages.addLine(ChatColorUtil.formatForUser(xTeam.getCommandManager().getUsage(temp) + " - Join a team"));
		//		if (PermissionUtil.hasPermission(originalSender, xTeam.getCommandManager().getPermissionNode(temp = "user_leave")))
		//			pages.addLine(ChatColorUtil.formatForUser(xTeam.getCommandManager().getUsage(temp) + " - Leave your team"));
		//		if (PermissionUtil.hasPermission(originalSender, xTeam.getCommandManager().getPermissionNode(temp = "user_accept")))
		//			pages.addLine(ChatColorUtil.formatForUser(xTeam.getCommandManager().getUsage(temp) + " - Accept the most recent team invite"));
		//		if (PermissionUtil.hasPermission(originalSender, xTeam.getCommandManager().getPermissionNode(temp = "user_hq")))
		//			pages.addLine(ChatColorUtil.formatForUser(xTeam.getCommandManager().getUsage(temp) + " - Teleport to the team headquarters"));
		//		if (PermissionUtil.hasPermission(originalSender, xTeam.getCommandManager().getPermissionNode(temp = "user_tele")))
		//			pages.addLine(ChatColorUtil.formatForUser(xTeam.getCommandManager().getUsage(temp) + " - Teleport to nearest or specific teammate"));
		//		if (PermissionUtil.hasPermission(originalSender, xTeam.getCommandManager().getPermissionNode(temp = "user_return")))
		//			pages.addLine(ChatColorUtil.formatForUser(xTeam.getCommandManager().getUsage(temp) + " - Teleport to saved return location (1 use)"));
		//		if (PermissionUtil.hasPermission(originalSender, xTeam.getCommandManager().getPermissionNode(temp = "user_chat")))
		//			pages.addLine(ChatColorUtil.formatForUser(xTeam.getCommandManager().getUsage(temp) + " - Toggle chatting with teammates"));
		//		if (PermissionUtil.hasPermission(originalSender, xTeam.getCommandManager().getPermissionNode(temp = "user_chat")))
		//			pages.addLine(ChatColorUtil.formatForUser(xTeam.getCommandManager().getUsage("user_message") + " - Send message to teammates"));
		...
		//			pages.addLine(ChatColorUtil.formatForUser(xTeam.getCommandManager().getUsage(temp) + " - List team locations"));
		...
		//			pages.addLine(ChatColorUtil.formatForUser(xTeam.getCommandManager().getUsage(temp) + " - Track team location"));
		...
		//				pages.addLine(ChatColorUtil.formatForAdmin(xTeam.getCommandManager().getUsage(temp) + " - Add a new location"));
		...
		//				pages.addLine(ChatColorUtil.formatForAdmin(xTeam.getCommandManager().getUsage(temp) + " - Remove a location"));
		...
		//				pages.addLine(ChatColorUtil.formatForLeader(xTeam.getCommandManager().getUsage(temp) + " - Set the team tag"));
		//			if (PermissionUtil.hasPermission(originalSender, xTeam.getCommandManager().getPermissionNode(temp = "leader_setleader")))
		//				pages.addLine(ChatColorUtil.formatForLeader(xTeam.getCommandManager().getUsage(temp) + " - Set new leader for the team"));
		//		}
