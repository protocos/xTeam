...
public class InviteTest
{
	...
	public void ShouldBeTeamAdminInviteExecute()
	{
		...
		BaseUserCommand fakeCommand = new UserInvite(fakePlayerSender, "invite Lonely");
		//ACT
	...
	public void ShouldBeTeamAdminInviteExecutePlayerNeverPlayed()
	{
		//ASSEMBLE
		FakePlayerSender fakePlayerSender = new FakePlayerSender("kmlanglois", new FakeLocation());
		BaseUserCommand fakeCommand = new UserInvite(fakePlayerSender, "invite newbie");
		//ACT
		boolean fakeExecuteResponse = fakeCommand.execute();
		//ASSERT
	...
	public void ShouldBeTeamAdminInviteExecutePlayerNoTeam()
	{
		...
		BaseUserCommand fakeCommand = new UserInvite(fakePlayerSender, "invite mastermind");
		//ACT
		boolean fakeExecuteResponse = fakeCommand.execute();
		//ASSERT
	...
	public void ShouldBeTeamAdminInviteExecuteSelfInvite()
	{
		//ASSEMBLE
		FakePlayerSender fakePlayerSender = new FakePlayerSender("kmlanglois", new FakeLocation());
		BaseUserCommand fakeCommand = new UserInvite(fakePlayerSender, "invite kmlanglois");
		//ACT
		boolean fakeExecuteResponse = fakeCommand.execute();
		//ASSERT
