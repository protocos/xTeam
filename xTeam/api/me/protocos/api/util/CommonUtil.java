...
public class CommonUtil
{
	...
	public static double round(double value, double decimalPlaces)
	{
		double places = Math.pow(10, decimalPlaces);
	...
	public static <K, V> OrderedHashMap<K, V> emptyOrderedHashMap()
	{
		return new OrderedHashMap<K, V>();
	}
