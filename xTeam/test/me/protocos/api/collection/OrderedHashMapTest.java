...
{
	OrderedHashMap<String, String> list;

	@Before
	public void SetUp()
	{
		list = new OrderedHashMap<String, String>();
	}
	...
	@Test
	public void ShouldBeOrderedHashMapAsList()
	{
		list.put("6", "six");
		list.put("4", "four");
		list.put("1", "one");
	...
	@Test
	public void ShouldBeOrderedHashMapAsHashMap()
	{
		list.put("6", "six");
		list.put("4", "four");
		list.put("1", "one");
		...
		map.put("3", "three");
		map.put("2", "two");
		Assert.assertEquals(map, list.toHashMap());
	}
	...
	{
		//ASSEMBLE
		OrderedHashMap<String, String> list1 = new OrderedHashMap<String, String>();
		OrderedHashMap<String, String> list2 = new OrderedHashMap<String, String>();
		list1.put("1", "one");
		list2.put("1", "one");
		list1.put("2", "two");
		list2.put("2", "two");
	...
	@Test
	public void ShouldBeMapBuilderExportOrderedHashMap()
	{
		//ASSEMBLE
		OrderedHashMap<String, String> hashList = new OrderedHashMap.Builder<String, String>()
				.addEntry("1", "one")
				.addEntry("2", "two")
				.addEntry("3", "three")
				.addEntry("4", "four")
