...
public class PatternConsoleTest
{
	...
	{
		Assert.assertTrue(xTeam.getInstance().getCommandManager().getUsage("console_" + baseCmd).replaceAll("[\\[\\]\\{\\}]", "").matches("/team " + xTeam.getInstance().getCommandManager().getPattern("console_" + baseCmd)));
	}
}
