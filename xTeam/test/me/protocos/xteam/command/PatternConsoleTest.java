...
public class PatternConsoleTest
{
	...
	public void ShouldBeConsoleDelete()
	{
		...
		Assert.assertTrue(command.matches(xTeamPlugin.getInstance().getCommandManager().getPattern("console_" + baseCmd)));
		command = "disband TEAM ";
		Assert.assertTrue(command.matches(xTeamPlugin.getInstance().getCommandManager().getPattern("console_" + baseCmd)));
		command = "disband";
		Assert.assertFalse(command.matches(xTeamPlugin.getInstance().getCommandManager().getPattern("console_" + baseCmd)));
		command = "disband ";
		Assert.assertFalse(command.matches(xTeamPlugin.getInstance().getCommandManager().getPattern("console_" + baseCmd)));
		command = "d TEAM";
		Assert.assertFalse(command.matches(xTeamPlugin.getInstance().getCommandManager().getPattern("console_" + baseCmd)));
	...
	{
		Assert.assertTrue(xTeamPlugin.getInstance().getCommandManager().getUsage("console_" + baseCmd).replaceAll("[\\[\\]\\{\\}]", "").matches("/team " + xTeamPlugin.getInstance().getCommandManager().getPattern("console_" + baseCmd)));
	}
}
