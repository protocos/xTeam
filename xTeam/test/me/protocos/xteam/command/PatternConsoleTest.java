...
public class PatternConsoleTest
{
	...
	public void ShouldBeConsoleDelete()
	{
		...
		Assert.assertTrue(command.matches(xTeam.getCommandManager().getPattern("console_" + baseCmd)));
		command = "disband TEAM ";
		Assert.assertTrue(command.matches(xTeam.getCommandManager().getPattern("console_" + baseCmd)));
		command = "disband";
		Assert.assertFalse(command.matches(xTeam.getCommandManager().getPattern("console_" + baseCmd)));
		command = "disband ";
		Assert.assertFalse(command.matches(xTeam.getCommandManager().getPattern("console_" + baseCmd)));
		command = "d TEAM";
		Assert.assertFalse(command.matches(xTeam.getCommandManager().getPattern("console_" + baseCmd)));
	...
	{
		Assert.assertTrue(xTeam.getCommandManager().getUsage("console_" + baseCmd).replaceAll("[\\[\\]\\{\\}]", "").matches("/team " + xTeam.getCommandManager().getPattern("console_" + baseCmd)));
	}
}
