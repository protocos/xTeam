...
public class PatternAdminTest
{
	...
	{
		Assert.assertTrue(xTeam.getInstance().getCommandManager().getUsage("admin_" + baseCmd).replaceAll("Page", "1").replaceAll("[\\[\\]\\{\\}]", "").matches("/team " + xTeam.getInstance().getCommandManager().getPattern("admin_" + baseCmd)));
	}
}
