...
public class UserTeleportTest
{
	...
	{
		//ASSEMBLE
		TeamPlayer testPlayer = CommonUtil.assignFromType(xTeamPlugin.getInstance().getPlayerManager().getPlayer("kmlanglois"), TeamPlayer.class);
