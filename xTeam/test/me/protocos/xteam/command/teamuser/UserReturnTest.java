...
public class UserReturnTest
{
	...
	public void ShouldBeTeamUserReturnExecute()
	{
		...
		TeamPlayer teamPlayer = CommonUtil.assignFromType(xTeamPlugin.getInstance().getPlayerManager().getPlayer("protocos"), TeamPlayer.class);
		Location returnLocation = xTeamPlugin.getInstance().getTeamManager().getTeam("one").getHeadquarters().getLocation();
		xTeamPlugin.getInstance().getPlayerManager().getPlayer("protocos").setReturnLocation(returnLocation);
	...
	public void ShouldBeTeamUserReturnExecutePlayerDying()
	{
		...
		xTeamPlugin.getInstance().getPlayerManager().getPlayer("protocos").setReturnLocation(new FakeLocation());
	...
	public void ShouldBeTeamUserReturnExecuteRecentAttacked()
	{
		...
		xTeamPlugin.getInstance().getPlayerManager().getPlayer("protocos").setLastAttacked(System.currentTimeMillis());
		FakePlayerSender fakePlayerSender = new FakePlayerSender("protocos", new FakeLocation());
		Location before = fakePlayerSender.getLocation();
		xTeamPlugin.getInstance().getPlayerManager().getPlayer("protocos").setReturnLocation(new FakeLocation());
		UserCommand fakeCommand = new UserReturn();
