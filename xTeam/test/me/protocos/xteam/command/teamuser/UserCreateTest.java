...
public class UserCreateTest
{
	...
	public void ShouldBeTeamUserCreateExecute()
	{
		...
		Assert.assertTrue(xTeamPlugin.getInstance().getTeamManager().contains("newteam"));
		Assert.assertTrue(xTeamPlugin.getInstance().getTeamManager().getTeam("newteam").getPlayers().contains("Lonely"));
		Assert.assertTrue(xTeamPlugin.getInstance().getTeamManager().getTeam("newteam").getAdmins().contains("Lonely"));
		Assert.assertTrue(xTeamPlugin.getInstance().getTeamManager().getTeam("newteam").getLeader().equals("Lonely"));
	...
	public void ShouldBeTeamUserCreateExecuteCapitalLetters()
	{
		...
		Assert.assertEquals("NEW", xTeamPlugin.getInstance().getTeamManager().getTeam("NEW").getName());
		Assert.assertTrue(xTeamPlugin.getInstance().getTeamManager().contains("NEW"));
		Assert.assertTrue(fakeExecuteResponse);
	}
	@Test
	public void ShouldBeTeamUserCreateExecuteNameTooLong()
	{
		...
		Assert.assertFalse(xTeamPlugin.getInstance().getTeamManager().contains("newteamiswaytoolong"));
	...
	public void ShouldBeTeamUserCreateExecuteOnlyDefault()
	{
		...
		Assert.assertFalse(xTeamPlugin.getInstance().getTeamManager().contains("newteam"));
		Assert.assertFalse(fakeExecuteResponse);
	}
	@Test
	...
	public void ShouldBeTeamUserCreateExecuteTeamNotAlpha()
	{
		...
		Assert.assertFalse(xTeamPlugin.getInstance().getTeamManager().contains("©§·"));
		Assert.assertFalse(fakeExecuteResponse);
	}
	@After
