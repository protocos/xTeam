...
public class ConsolePromoteTest
{
	...
	{
		//ASSEMBLE
		xTeamPlugin.getInstance().getTeamManager().getTeam("one").demote("protocos");
	...
	public void ShouldBeConsolePromoteExecuteIncorrectTeam()
	{
		...
		Assert.assertFalse(xTeamPlugin.getInstance().getTeamManager().getTeam("one").getAdmins().contains("mastermind"));
	...
	public void ShouldBeConsolePromoteExecutePlayerHasNotPlayed()
	{
		...
		Assert.assertFalse(xTeamPlugin.getInstance().getTeamManager().getTeam("one").getAdmins().contains("newbie"));
		Assert.assertFalse(fakeExecuteResponse);
	}
	@Test
	public void ShouldBeConsolePromoteExecuteTeamNotExists()
	{
		...
		Assert.assertFalse(xTeamPlugin.getInstance().getTeamManager().getTeam("one").getAdmins().contains("protocos"));
		Assert.assertFalse(fakeExecuteResponse);
	}
	@After
