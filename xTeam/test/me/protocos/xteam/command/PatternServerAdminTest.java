...
public class PatternServerAdminTest
{
	...
	public void ShouldBeServerAdminChatSpy()
	{
		baseCmd = "chatspy";
		command = "chatspy";
		Assert.assertTrue(command.matches(xTeam.getCommandManager().getPattern("serveradmin_" + baseCmd)));
		command = "chatspy ";
		Assert.assertTrue(command.matches(xTeam.getCommandManager().getPattern("serveradmin_" + baseCmd)));
		command = "chspy";
		Assert.assertTrue(command.matches(xTeam.getCommandManager().getPattern("serveradmin_" + baseCmd)));
		...
		Assert.assertTrue(command.matches(xTeam.getCommandManager().getPattern("serveradmin_" + baseCmd)));
		command = "c";
		Assert.assertFalse(command.matches(xTeam.getCommandManager().getPattern("serveradmin_" + baseCmd)));
	...
	{
		Assert.assertTrue(xTeam.getCommandManager().getUsage("serveradmin_" + baseCmd).replaceAll("Page", "1").replaceAll("[\\[\\]\\{\\}]", "").matches("/team " + xTeam.getCommandManager().getPattern("serveradmin_" + baseCmd)));
	}
}
