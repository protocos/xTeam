...
public class PatternServerAdminTest
{
	...
	public void ShouldBeServerAdminChatSpy()
	{
		baseCmd = "chatspy";
		command = "chatspy";
		Assert.assertTrue(command.matches(xTeamPlugin.getInstance().getCommandManager().getPattern("serveradmin_" + baseCmd)));
		command = "chatspy ";
		Assert.assertTrue(command.matches(xTeamPlugin.getInstance().getCommandManager().getPattern("serveradmin_" + baseCmd)));
		command = "chspy";
		Assert.assertTrue(command.matches(xTeamPlugin.getInstance().getCommandManager().getPattern("serveradmin_" + baseCmd)));
		...
		Assert.assertTrue(command.matches(xTeamPlugin.getInstance().getCommandManager().getPattern("serveradmin_" + baseCmd)));
		command = "c";
		Assert.assertFalse(command.matches(xTeamPlugin.getInstance().getCommandManager().getPattern("serveradmin_" + baseCmd)));
	...
	{
		Assert.assertTrue(xTeamPlugin.getInstance().getCommandManager().getUsage("serveradmin_" + baseCmd).replaceAll("Page", "1").replaceAll("[\\[\\]\\{\\}]", "").matches("/team " + xTeamPlugin.getInstance().getCommandManager().getPattern("serveradmin_" + baseCmd)));
	}
}
